...
function display_data(data) {
    if (data && (data != prev_data)) {      // if there is data, and it's changed
        ...
        $('div#cpu-percent').html(data.cpu.percent);
        $('div#cpu-count').html(data.cpu.count);
        $('div#mem-percent').html(data.mem.percent);
        $('div#mem-free').html(data.mem.free);
        $('div#mem-available').html(data.mem.available);
        $('div#mem-total').html(data.mem.total);
        $('div#mem-used').html(data.mem.used);
